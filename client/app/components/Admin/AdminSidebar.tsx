        ...
        <Menu iconShape="square">
              ...
              <Box mb="25px">
                <Box display="flex" justifyContent="center" alignItems="center">
                  <Image
                    ...
                    height={100}
                    alt=""
                    src={user.avatar ? user.avatar.url : avatarDefault} /></Box>
                <Box textAlign="center">
                  <Typography
                    variant="h4"
                    className="!text-[20px] font-Poppins text-black dark:text-[#ffffffc1]"
                    sx={{ m: "10px 0 0 0" }}>
                    {user?.name}
                  </Typography>
                  <Typography
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Typography
              ...
              className="!text-[18px] text-black dark:text-[#ffffffc1] !font-[400] capitalize"
            >
              {
                !isCollapsed && "Data"
              }
