...
const CourseContent: FC<Props> = ({ active, setActive, setCourseContentData, courseContentData, handleSubmit: handleCourseSubmit }) => {
        ...
        if(
            ...
            else
            {
                ...
                const newContent = 
                {
                    ...
                    title:"",
                    description:"",
                    videoSection:`Untitled Section ${activeSections}`,
                    links:[{title:"",url:""}]
                };
                setCourseContentData([...courseContentData,newContent]);
            }
                                        ...
                                        !isCollapsed[index] && (
                                            <>
                                                    ...
                                                    item?.links.map((link:any,linkIndex:number)=>(
                                                        <div className="mb-3 block" key={link}>
                                                            <div className="w-full flex items-center justify-between">
                                                                ...
                                                                <AiOutlineDelete
                                                                className={
                                                                    `${linkIndex===0 ? "cursor-no-drop":"cursor-pointer"} text-black dark:text-white text-[20px]`
                                                                }
                                                                onClick={() =>
                                                ...
                                                <div className="inline-block mb-4">
                                                    ...
                                                    >
                                                        <BsLink45Deg className=""/> Add Link
                                                    </p>
                                                </div>
                                            </>
                                        )
