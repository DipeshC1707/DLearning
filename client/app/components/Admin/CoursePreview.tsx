        ...
        <div className="w-[90%] m-auto py-5 mb-5">
            <div className="w-full relative">
                ...
                <div className="flex items-center">
                    ...
                    <h5 className="pl-3 text-[20px] mt-2 line-through opcity-80">
                ...
                <div className="flex items-center">
                    <div className={`${styles.button} !w-[180px] my-2 font-Poppins !bg-[crimson] cursor-not-allowed`}>
                ...
                <p className="pb-1">* Sourec Code Included</p>
                <p className="pb-1">* Fulll Lifetime Access</p>
